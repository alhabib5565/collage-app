...

            {
                loading ? <Loader></Loader>
                    : <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mx-auto'>
                        {
                            collages.slice(0, 3).map((collage, index) => <div key={index} className="card mx-auto border-2 border-gray-300 hover:border-gray-600 duration-500 w-full bg-base-100 shadow-xl">
                                <figure><img className='w-full px-7 pt-7 rounded h-[200px]' src={collage?.collageImage} alt="collage image" /></figure>
                                <div className="card-body relative">
                                    ...
                                    <Link className='w-full' to={`/collage/${collage._id}`}>
